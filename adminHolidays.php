        ...
        <div class="main_container">
            ...
            <div class="right_col" role="main">
                ...
                if (isset($_SESSION['saveHolidays'])) {
                    ...
                    unset($_SESSION['saveHolidays']);
                }

                if (isset($_SESSION['errorHolidays'])) {
                    echo "
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Add New Holidays;</h5>
                            ...
                            <div class="modal-body">
                                <form action="add_holidays.php" method="POST">
                                    <div class="mb-3">
                                        <label for="dateHolidays" class="form-label">Date :</label>
                                        <input type="date" class="form-control" id="dateHolidays" name="dateHolidays"
                                            required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="holidays" class="form-label">Description :</label>
                                        <input type="text" class="form-control" id="holidays" name="holidays" required>
                                    </div>
                ...
                <button class="btn btn-info" id="holidaysOverview" data-bs-toggle="tooltip" data-bs-html="true" title="
    <div style='text-align: left; max-width: 260px; font-size: 14px; line-height: 1.5;'>
        <strong>📆 Holidays Table Overview:</strong><br>
        <span style='color: #007bff;'>🔹</span> Lists <strong>official holidays</strong> and non-working days.<br>
        <span style='color: #28a745;'>⚡</span> Helps in <strong>scheduling and availability management</strong>.<br>
        <span style='color: #17a2b8;'>📝</span> Supports <strong>adding, editing, and removing</strong> holidays.<br>
        <span style='color: #dc3545;'>❗</span> Prevents scheduling conflicts on non-working days.<br>
    </div>
">
    Table Overview 🛈
</button>
