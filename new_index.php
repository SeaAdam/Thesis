            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-white py-lg-0 px-lg-3">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav">
                        ...
                        <a href="service.html" class="nav-item nav-link">Services and Requirements</a>
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    ...
                    <p class="mb-4">Welcome to Brain Master Diagnostic Center, a trusted provider of specialized
                        diagnostic services for over a decade. We pride ourselves on delivering high-quality, reliable
                        diagnostic tests, including drug testing, neurological examinations, and psychological
                        assessments. Our center is equipped with advanced technology and staffed by a team of skilled
            ...
            <div class="row g-0">
                <div class="col-lg-6 pt-lg-5">
                    <div class="bg-white p-5 mt-lg-5">
                        <h1 class="display-6 mb-4 wow fadeIn" data-wow-delay="0.3s">Brain Master Diagnostic and Medical
                            Center</h1>
                        <p class="mb-4 wow fadeIn" data-wow-delay="0.4s">Our services cater to individual patients
                            needing specialized diagnostics, healthcare providers referring patients, corporate clients
                            requiring employee health assessments, and government agencies seeking certified diagnostic
                            services.</p>
        ...
        <div class="container">
            ...
            <div class="business-model">
                <div class="model-item">
                    ...
                    <p>We serve individual patients, healthcare providers, corporate clients, and government agencies.
                    </p>
                </div>
                ...
                <div class="model-item">
                    <h4>Key Resources</h4>
                    <p>Our key resources include experienced staff, advanced equipment, and necessary certifications.
                    </p>
                </div>
