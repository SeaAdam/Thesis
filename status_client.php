...
<div class="col-md-6 col-sm-6 client-booking-overview">
    <div class="x_panel">
        <div class="x_title">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        let reportBtn = document.querySelector(".client-booking-overview .report-btn");
        let reportCard = document.querySelector(".client-booking-overview .report-card");
